...
//     document.write(`<div>${simpsons[i].name} -
//                          ${simpsons[i].surname} -
//                          ${simpsons[i].age} -
//                          ${simpsons[i].info} -
...
<!--template 2.2-->
// for (let i = 0; i < simpsons.length; i++) {
//     document.write(`<div><h2>${simpsons[i].name} ${simpsons[i].surname}. age is - ${simpsons[i].age}  </h2>
//                        <p>${simpsons[i].info}</p>
//                         <img src=${simpsons[i].photo} alt=${simpsons[i].name}>
//                    </div>`)
// }
...
for (let i=0;i< products.length;i++ ){
    document.write(`<div class="product-card"><h3 class="product-title">${products[i].title}.Price - ${products[i].price} </h3></div> 
